              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-8">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Button onClick={() => handleSocialRedirect('github')} variant="outline" className="border-2 border-green-400 hover:bg-green-400 px-6 py-3 rounded-lg font-semibold transition-all duration-300 text-emerald-50">
